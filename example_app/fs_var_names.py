...
# Latitude and Longitude variables  # TODO: check right way round?
ORIGIN_AIRPORT_LONGITUDE = "AiLongi1"  # 3
ORIGIN_AIRPORT_LATITUDE = "AiLatit1"  # 3
REPORTING_AIRPORT_LONGITUDE = "AiLongit"  # 3, 4
REPORTING_AIRPORT_LATITUDE = "AiLatitu"  # 3, 4
