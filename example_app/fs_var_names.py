...
# Virtual Variables
# Combined Categories VV: Reporting Period combined up to years: 2, 4, v
...
REPORTING_PERIOD_CODE = "flReport"  # 2, 4, t

# Latitude and Longitude variables
ORIGIN_AIRPORT_LONGITUDE = "AiLongit"  # 3, 4, t
ORIGIN_AIRPORT_LATITUDE = "AiLatitu"  # 3, 4, t
REPORTING_AIRPORT_LONGITUDE = "AiLongi1"  # 3, t
REPORTING_AIRPORT_LATITUDE = "AiLatit1"  # 3, t
